...
class FoodTableMobile extends StatefulWidget {
  FoodTableMobile({Key key}) : super(key: key);

  @override
  _FoodTableMobile createState() => new _FoodTableMobile();
}

class _FoodTableMobile extends State<FoodTableMobile> {
                ...
                child: BoxlessDataTable(
                  ...
                  rows: snapshot.data.foods.map((value) {
                    return BoxlessDataRow(
                        ...
                        cells: [
                          BoxlessDataCell(Text(
                              "${value.name} (${value.servingSize * value.servings}g)")),
                          BoxlessDataCell(Text("${value.calories} cal")),
                          BoxlessDataCell(Text("${value.protein} g"))
                        ]);
                  }).toList(),
                ),
              );
